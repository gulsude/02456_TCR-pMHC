...
embeddings = ["blosum"]#  'Baseline', 'esm-1b',  , 'vhse'
    ...
    for nn in numHN:
        for nf in numFilter:
            ...
            pm.execute_notebook(input_path='main2.ipynb',
                                ...
                                output_path=NBDIR + '{}_{}_main2_encoding_{}_numHN_{}_filters_{}_dr_{}.ipynb'.format(date, current_time, emb, nn, nf, (int(dropOutRate*10))))
